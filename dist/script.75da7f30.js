...
// Exporting Module
console.log('Exporting Module'); // Variable are scoped in the current module, and we only can use heare. If we need to use them we need to exports.

var shippingCost = 10;
var cart = []; // If we want to export a single value we can write "Export infront of the declaration to export this value to other code."
...
},{"buffer":"node_modules/node-libs-browser/node_modules/buffer/index.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
console.log('Importing Module'); // // addToCart('bread',20)
...
(0, _shoppingCart.default)('hamburger', 2);
(0, _shoppingCart.default)('esfirra', 2); // Modules have a life conection the values will be iserted in the cart array and we can import heare in our code.

console.log(_shoppingCart.cart); // The module pattern

var shoppingCart2 = function () {
  var cart = [];
  var shoppingCost = 10;
  var totalPrice = 237;
  var totalQuantity = 33;

  var addToCart = function addToCart(product, quantity) {
    cart.push(product, quantity);
    console.log("".concat(quantity, " ").concat(product, " added to cart! shipping cost is ").concat(shoppingCost)); // This variable cant be access outside the module, but we see the value if we return in a function.
  };

  var orderStock = function orderStock(product, quantity) {
    cart.push(product, quantity);
    console.log("".concat(quantity, " ").concat(product, " ordered from supplyer!"));
  };
  ...
  return {
    ...
    cart: cart,
    totalQuantity: totalQuantity // Heare we are exporting an object with all of these methods that i retruned.
...
console.log(shoppingCart2.totalPrice); // Common JS -> Using in NODEjs
// Export
...
// We can simple use loadash because parcel understand where to get files.
...
var clonedObj = (0, _lodash.cloneDeep)(nestObj);
nestObj.teste.obj.value1 = false;
console.log(nestObj);
console.log(clonedObj);

if (module.hot) {
  // Prevent browser refresh statement.
  module.hot.accept();
}
},{"./shoppingCart.js":"shoppingCart.js","lodash":"node_modules/lodash/lodash.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41897" + '/');
